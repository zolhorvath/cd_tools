...
module.exports = {
  ...
  "Filled form": function test(browser) {
    ...
    ["", "he"].forEach(langprefix => {
      browser
        ...
        .smartURL(
          langprefix ? `/${langprefix}/contact/textform` : "/contact/textform"
        )
        // Text.
        ...
        .setValueAndChange(
          '[name="daterange[0][end_value][date]"]',
          "2018-10-28"
        )
        .setValueAndChange('[name="daterange[0][end_value][time]"]', "11:00:00")
        // Datetime range - all day.
        .setValueAndChange(
          '[name="daterange_ad[0][value][date]"]',
          "2018-12-01"
        )
        .setValueAndChange(
          '[name="daterange_ad[0][end_value][date]"]',
          "2018-10-28"
        )
        // Color.
        ...
        .perform(() => {
          if (fileTest) {
            ...
            browser
              .setValueAndChange(
                '[name="files[image_0]"]:not([disabled])',
                imagePath
              )
              ...
              // Valid file.
              .setValueAndChange(
                '[name="files[file_0]"]:not([disabled])',
                filePath
              )
