  ...
  'Dropbutton'(browser) {
    ...
    ['', 'he'].forEach((langprefix) => {
      browser
        ...
        .focusOn('.dropbutton[data-drupal-selector="edit-group-2"] li:first-child .button')
        .pause(300)
        .saveScreenShot('07', langprefix, 'Multiple input focused')
        .click('.dropbutton[data-drupal-selector="edit-group-2"] li:nth-child(2) button')
        .pause(300)
        .saveScreenShot('08', langprefix, 'Multiple input expanded')
        .focusOn('.dropbutton[data-drupal-selector="edit-group-2"] li:nth-child(4) .button')
        .pause(300)
